...
urlpatterns = [
    ...
    path('personel/', views.personnel_view, name='personnel_view'),
    path('personel/detail/<int:pk>', views.personnel_detail, name='personnel_detail'),
    path('personel/add/', views.add_personnel, name='add_personnel'),
    path('personel/edit/<int:pk>', views.edit_personnel, name='edit_personnel'),
    path('personel/delete/<int:pk>', views.delete_personnel, name='delete_personnel'),
