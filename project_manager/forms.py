...
class ProjectForm(ModelForm):
    ...
    class Meta:
        model = Project
        fields = ['name', 'description', 'budget', 'start_date', 'end_date', 'expected_revenue', 'revenue_unit', 'status']
...
class EmployeeForm(ModelForm):
    ...
    class Meta:
        model = Employee
        fields = ['project','first_name', 'last_name', 'email','join_date' , 'end_date', 'department', 'position']
